...
export default function SportsBooking() {
    ...
    const sports = [
        ...
        { id: 'cricket-nets', name: 'Cricket Nets', icon: '🏏' },
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {sports.map(sport => (
                                    <button
                                        ...
                                        className={`relative p-5 rounded-2xl transition-all duration-300 flex flex-col items-center gap-3 group ${selectedSport === sport.id
                                    ...
                                    >
                                        ...
                                        <span className={`font-semibold ${selectedSport === sport.id ? 'text-white' : 'text-gray-700'}`}>
                                            {sport.name}
                                        </span>
                                    </button>
                                ))}
                            ...
                            <div className="mb-4">
                                <div className="flex items-center justify-between mb-6">
                                    <button
                                        ...
                                        className={`p-2.5 rounded-xl transition-all duration-200 ${isPreviousMonthDisabled()
                                    ...
                                    {days.map((day, idx) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                disabled={disabled}
                                                className={`aspect-square rounded-xl text-sm font-semibold transition-all duration-200 ${disabled
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {slots.map(slot => (
                                    <button
                                        ...
                                        className={`relative p-4 rounded-xl transition-all duration-300 text-sm font-semibold ${selectedSlot === slot
                                            ? 'bg-gradient-to-br from-blue-500 to-purple-500 text-white shadow-lg scale-105'
                        ...
                        <div className="backdrop-blur-xl bg-white/40 border border-white/20 rounded-3xl shadow-xl p-6">
                            ...
                            <div className="flex items-center justify-center gap-6">
                                <button
                                    ...
                                    disabled={duration <= 1}
                                    className={`w-14 h-14 rounded-2xl font-bold text-2xl transition-all duration-200 flex items-center justify-center ${duration <= 1
                                        ? 'bg-gray-100 text-gray-300 cursor-not-allowed'
                            ...
                            <div className="space-y-3">
                                {turfs.map(turf => (
                                    <button
                                        ...
                                        className={`relative w-full p-4 rounded-xl transition-all duration-300 text-left font-semibold flex items-center gap-3 ${selectedTurf === turf.id
